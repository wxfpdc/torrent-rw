...
class MagnetTest extends PHPUnit_Framework_TestCase {
	...
	public function testRejectsInvalidMagnetLink() {
		...
		$this->setExpectedException("Openseedbox\Parser\ParseException");
	...
	public function testCreate() {
		...
		$this->assertEquals("magnet:?xt=urn:btih:07a9de9750158471c3302e4e95edb1107f980657&dn=Test+name&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80&tr=udp%3A%2F%2Ftracker.publicbt.com%3A80&tr=udp%3A%2F%2Ftracker.istole.it%3A6969&tr=udp%3A%2F%2Ftracker.ccc.de%3A80&tr=udp%3A%2F%2Fopen.demonii.com%3A1337", $created);
	...
	public function testCreateWithTrackers() {
		$created = $this->magnet->create("07a9de9750158471c3302e4e95edb1107f980657", "Test name", array("http://tracker1.com:80", "http://tracker2.com:8080"));
		$parsed = $this->magnet->parse($created);
